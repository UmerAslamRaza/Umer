                        ...
                        <div
                            ...
                            <div className="">
                                <div className="sidebar-profile">
                                    ...
                                    <h4 className="n5-color fw-semibold fs-five mt-2 text-center">Chris
                                        Evans</h4><span className="n5-color fs-nine d-block text-center">Senior Software Engineer</span>
                                    <div
                                        className="d-flex justify-content-center gap-2 align-items-center mt-4">
                                        <a className="social-icon" href="#"><i className="p1-color">
                                    ...
                                    <ul className="d-flex flex-column gap-3">
                                        ...
                                        <li className="rounded-3">
                                            <Link
                                                ...
                                                <span
                                                    className="n5-color bg2-color fs-ten px-1 pt-1 rounded-2 me-3">16</span>
                                            </Link>
                                        </li>
